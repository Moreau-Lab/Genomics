...
+ There are other, optional input files if you want to run some of the more involved analyses (regarding orthogroup function, for example).
...
I have created a [script](https://github.com/Moreau-Lab/Genomics/blob/master/VolcanoPlot.R) so that you can customize the volcano plots produced by Kinfin. 
