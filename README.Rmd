...
I have written [an R script to do this](https://github.com/Moreau-Lab/Genomics/blob/master/KinfinToGOATOOLS.R); simply provide the paths to your particular Kinfin results, and the script will produce the necessary `study`, `population`, and `association` files for GOATOOLS.
